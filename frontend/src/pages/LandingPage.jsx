    ...
    >
      ...
      >
        ...
        <div style={{ maxWidth: 820, margin: "0 auto", position: "relative" }}>
          ...
          >
            Optimize Your Resume. <span className="gradient-text">Land More Interviews.</span>
          </h1>
          ...
          >
            Instant ATS score, skill gap analysis, bullet-point improvements, and AI mock interviews
            — all in one place.
          </p>
              ...
              <div key={i} style={{ background: "#ffffff", padding: "18px 20px" }}>
                <div
                  style={{
                    fontSize: 17,
                    fontWeight: 800,
                    color: i === 0 ? "#4f46e5" : i === 1 ? "#0891b2" : "#16a34a",
                    marginBottom: 3,
                  }}
                >
                  {m.value}
      ...
      <section style={{ padding: "clamp(60px,8vw,90px) 20px", maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          {FEATURES.map((f, i) => (
            <div key={i} className="card-base card-hover" style={{ padding: "26px 24px" }}>
              <div
                style={{
                  width: 44,
                  height: 44,
            ...
            {[
              {
                ...
                desc: "Sign up instantly with Google or email to access your personal resume workspace.",
              },
              {
                n: "02",
                title: "Upload resume & job details",
                desc: "Drop in your PDF or DOCX and optionally paste the job description you're targeting.",
              },
              {
                n: "03",
                title: "Review scores & act on insights",
                desc: "Get a full breakdown — ATS score, skill gap matrix, and concrete improvement suggestions.",
              },
            ].map((s, i) => (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {FAQS.map((faq, i) => (
            ...
            >
              ...
              >
                <span
                  style={{ fontSize: 14.5, fontWeight: 600, color: "#1e293b", lineHeight: 1.4 }}
                >
                  {faq.q}
                </span>
                <span
      ...
      {/* ── FOOTER ── */}
      <footer
        style={{ background: "#ffffff", borderTop: "1px solid #e8ecf4", padding: "26px 20px" }}
      >
        <div
          style={{
            maxWidth: 1100,
        ...
        >
          <span
            style={{ fontSize: 15, fontWeight: 800, color: "#0f172a", letterSpacing: "-0.02em" }}
          >
            Vettora
          </span>
          <span style={{ fontSize: 13, color: "#94a3b8" }}>
            © {new Date().getFullYear()} Vettora. All rights reserved.
          </span>
