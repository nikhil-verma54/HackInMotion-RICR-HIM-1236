    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", textAlign: "center", maxWidth: 340 }}>
          <div style={{ width: 56, height: 56, borderRadius: 16, background: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 28px", fontSize: 22, color: "#fff" }}>✦</div>
          ...
          <p style={{ fontSize: 15, color: "rgba(255,255,255,0.75)", lineHeight: 1.65, margin: "0 0 36px" }}>
            Join thousands of professionals who use Vettora to land their next role.
          </p>

          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              { icon: "⚡", text: "Get your resume analyzed in seconds" },
              { icon: "📊", text: "Track progress across multiple resumes" },
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 24px" }}>
        <div style={{ width: "100%", maxWidth: 380 }}>
          <div style={{ marginBottom: 32 }}>
            ...
            <h1 style={{ fontSize: 26, fontWeight: 800, color: "#0f172a", margin: "0 0 6px", letterSpacing: "-0.03em" }}>Create your account</h1>
          ...
          <button
            ...
            style={{ width: "100%", padding: "12px", fontSize: 14, borderRadius: 12, marginBottom: 16 }}
          >
          ...
          <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div>
              ...
              <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" className="input-base" style={{ fontSize: 14 }} />
            </div>
            <div>
              <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#334155", marginBottom: 6 }}>Password</label>
              <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min. 6 characters" className="input-base" style={{ fontSize: 14 }} />
            </div>
            <div>
              <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#334155", marginBottom: 6 }}>Confirm password</label>
              <input type="password" required value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="••••••••" className="input-base" style={{ fontSize: 14 }} />
            </div>
...
function getFirebaseError(code) {
  switch (code) {
    ...
    case "auth/popup-closed-by-user": return "Google signup was cancelled.";
    default: return "Unable to create account. Please try again.";
  }
}
