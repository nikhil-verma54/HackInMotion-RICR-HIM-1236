      ...
      >
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", position: "relative" }}>
          ...
          <p style={{ fontSize: 16, color: "#475569", lineHeight: 1.7, margin: 0 }}>
            We built Vettora to level the playing field between candidates and modern recruitment
            algorithms.
          </p>
        </div>
      </section>
        ...
        >
          <div className="card-base" style={{ padding: "30px 26px" }}>
            ...
            <p style={{ fontSize: 14, color: "#64748b", lineHeight: 1.7, margin: 0 }}>
              Over 75% of qualified applicants are filtered out by Applicant Tracking Systems due to
              formatting errors, missing keywords, or non-standard section headers — before a
              recruiter even reads the resume.
            </p>
          </div>
          <div className="card-base" style={{ padding: "30px 26px" }}>
            <div
            ...
            <p style={{ fontSize: 14, color: "#64748b", lineHeight: 1.7, margin: 0 }}>
              Vettora uses advanced semantic evaluation to inspect your resume like a senior
              technical recruiter and ATS parser combined — giving you instant clarity on what
              works, what's missing, and exactly how to fix it.
            </p>
          </div>
        </div>
        ...
        <div className="card-base" style={{ padding: "32px 28px", marginBottom: 28 }}>
          <div style={{ marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 13.5, color: "#64748b", margin: 0 }}>
              Every analysis covers four critical dimensions of your resume.
            </p>
          </div>
          <div
            style={{
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: 13.5, color: "#15803d", lineHeight: 1.65, margin: 0 }}>
              Your career documents belong strictly to you. Resume content is processed securely and
              is never sold, shared, or used to train public language models.
            </p>
          </div>
        </div>
